...
with st.chat_message("assistant"):
    st.markdown("こちらは社内情報特化型の生成AIチャットボットです。上記の回答モードで「社内文書検索」か「社内問い合わせ」のどちらかを選択し、チャット欄から自由に質問してください。")
    st.markdown("**「社内文書検索」の場合の入力例**")
    st.info("2024年12月に行った、自社サービス「HealthX」のマーケティング施策についてのMTG議事録")
